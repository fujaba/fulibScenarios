...
public class CodeGenerator implements ScenarioGroup.Visitor<Object, Object>, Scenario.Visitor<Object, Object>, Sentence.Visitor<Object, Object>
{
   ...
   private ClassModelBuilder modelBuilder;
   ...
   {
      this.modelBuilder = new ClassModelBuilder(scenarioGroup.getName(), this.config.getModelDir());
      ...
      new Generator().generate(this.modelBuilder.getClassModel());
